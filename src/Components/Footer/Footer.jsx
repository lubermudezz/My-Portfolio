...
const Footer = () => {
  return (
    <div className='footerContainer'>
        ...
        <button className='buttonFooter'><a id='mouseChange' target='_blank' href='https://drive.google.com/file/d/1JJCO7MYCYZTu-pC0-7mQebwfCRnDHTxW/view?usp=sharing'>Accedé a mi CV</a></button>
    </div>
  )
}
