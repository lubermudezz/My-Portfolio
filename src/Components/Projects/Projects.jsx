    ...
    return (
        <div className='projectDiv'>
            <div className='projectContainer'>
                <Card title="Henry's Resto Project" tech='TypeScript, React | Redux, Node.js, MongoDB, Mongoose, Stripe, Tailwind, Cliengo, Google API, Nodemailer ' text='E-Commerce de comidas, proyecto grupal en el que implementamos autenticación local y de terceros, envío de notificaciones, chatbot, sistema de localización para entrega de pedidos, carrito y pasarela de pagos' linkDeploy={'https://henrys-resto-lubermudezz.vercel.app/'} linkGithub='https://github.com/lubermudezz/HenrysRestoProject-Frontend' video={restoVid} />
